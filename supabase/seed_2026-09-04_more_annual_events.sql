...
('artsbeatseats-2026', 'Arts, Beats & Eats',
 ...
 'Official festival site (artsbeatseats.com) wasn''t directly fetchable this session (redirect loop) — price/dates cross-checked via its Showpass ticketing page and ClickOnDetroit''s 2026 coverage instead.', 'approved'),
...
('mistatefair-2026', 'Michigan State Fair',
 ...
 'price_from is base "Fair Admission" ($10); an "Ultimate Admission" tier ($42, includes rides/shows) also exists.', 'approved'),
